...
import numpy as np
import matplltlib.pyplot as plt
...
#retrieving the imgs and their labels
print("Obtaining Imgs and it Labels.........")
for i in range(classes):
    path = os.path.join(cur_path, r'C:\Users\shrav\Downloads\code.zip\code\dataset', str(i))
